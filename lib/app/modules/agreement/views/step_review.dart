      ...
      child: Column(
        ...
        children: [
            ...
            child: Column(
              ...
              children: [
                ...
                Obx(
                  () => _buildSummaryRow(
                    "Duration",
                    controller.rentalDuration.value,
                    textWhite,
                    textGrey,
                  ),
                ),
                  ...
                  if (controller.requireDeposit.value) {
                    return Padding(
                      ...
                      child: _buildSummaryRow(
                        "Security Deposit",
                        "\$${controller.depositController.text}",
          ...
          Container(
            ...
            //   final activeFees = controller.damageFees.entries
            //       .where((e) => e.value['enabled'] == true)
            //       .toList();

            //   if (activeFees.isEmpty)
            //     return Text(
            //       "No specific damage fees applied.",
            //       style: TextStyle(
            //         color: textGrey,
          ...
          Container(
            ...
            decoration: BoxDecoration(
              color: const Color(
                0xFFf0f4f4,
              ), // Light background for signature contrast
              borderRadius: BorderRadius.circular(12),
            ),
            child: Stack(
              children: [
