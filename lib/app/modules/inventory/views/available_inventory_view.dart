...
import '../controllers/inventory_controller.dart'; // Needed for FilterChip logic if reusing types

class AvailableInventoryView extends GetView<AvailableInventoryController> {
  const AvailableInventoryView({super.key});
    ...
    return SizedBox(
      ...
      child: ListView(
        ...
        children: [
          ...
          // Status Check removed for Available Inventory View
          Obx(
            () => _buildChipUI(
              context,
              controller,
